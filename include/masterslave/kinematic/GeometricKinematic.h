...
private:
   ...
   */
  bool rcmCallback(masterslave::GeometricKinematicRCM::Request &req,
   ...
   */
  bool directKinematicsCallback(masterslave::GeometricKinematicDirectKinematics::Request &req,
                                masterslave::GeometricKinematicDirectKinematics::Response &resp);

  /**
   * @fn inverseKinematicsCallback
   * @brief Callback für den inversen Kinematik-Service, inder die Flanschlage im Weltkoordinatensystem und die
   * Gelenkwinkel des Werkzeuges berechnet werden
   ...
   */
  bool inverseKinematicsCallback(masterslave::GeometricKinematicInverseKinematics::Request &req,
