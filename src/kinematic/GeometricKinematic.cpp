...
GeometricKinematic::GeometricKinematic(ros::NodeHandle &nh) : nh_(nh)
{
  ...
  directKinematicsServer =
      nh_.advertiseService("/directKinematics", &GeometricKinematic::directKinematicsCallback, this);
  inverseKinematicsServer =
      nh_.advertiseService("/inverseKinematics", &GeometricKinematic::inverseKinematicsCallback, this);

  ros::spin();
}

bool GeometricKinematic::rcmCallback(masterslave::GeometricKinematicRCM::Request &req,
                                     masterslave::GeometricKinematicRCM::Response &resp)
{
  Eigen::Affine3d T_0_FL;
  tf::poseMsgToEigen(req.T_0_FL, T_0_FL);
  RCM = T_0_FL * buildAffine3d(Eigen::Vector3d(TOOL_PARAMETERS.X_RCM, TOOL_PARAMETERS.Y_0_Q4, TOOL_PARAMETERS.Z_0_Q4),
...
bool GeometricKinematic::directKinematicsCallback(masterslave::GeometricKinematicDirectKinematics::Request &req,
                                                  masterslave::GeometricKinematicDirectKinematics::Response &resp)
{
  Eigen::Affine3d T_0_FL;
  tf::poseMsgToEigen(req.T_0_FL, T_0_FL);
...
bool GeometricKinematic::inverseKinematicsCallback(masterslave::GeometricKinematicInverseKinematics::Request &req,
                                                   masterslave::GeometricKinematicInverseKinematics::Response &resp)
{
...
{
  T_FL_Q4 = buildAffine3d(Eigen::Vector3d(TOOL_PARAMETERS.X_0_Q4, TOOL_PARAMETERS.Y_0_Q4, TOOL_PARAMETERS.Z_0_Q4),
                          Eigen::Vector3d(TOOL_PARAMETERS.A_0_Q4 * DEG_TO_RAD, TOOL_PARAMETERS.B_0_Q4 * DEG_TO_RAD,
                                          TOOL_PARAMETERS.C_0_Q4 * DEG_TO_RAD),
                          true);
  T_FL_Q4.rotate(Eigen::AngleAxis<double>(jointAngles(0), Eigen::Vector3d::UnitZ()));
  Eigen::Affine3d T_Q4_Q5 = buildAffine3d(Eigen::Vector3d::Zero(),
                                          Eigen::Vector3d(90 * DEG_TO_RAD, 0, 90 * DEG_TO_RAD + jointAngles(1)), false);
...
bool GeometricKinematic::calcInvKin(Eigen::Affine3d desEEPosition)
{
  ...
  Eigen::Affine3d T_EE_Q5 =
      buildAffine3d(Eigen::Vector3d::Zero(), Eigen::Vector3d(90 * DEG_TO_RAD, 0, -jointAnglesTar(2)), true);
  ...
  Eigen::Affine3d T_Q5_Q4 = buildAffine3d(
      Eigen::Vector3d::Zero(), Eigen::Vector3d(-90 * DEG_TO_RAD, 0, -90 * DEG_TO_RAD - jointAnglesTar(1)), true);
  ...
  Eigen::Affine3d T_Q4_FL =
      buildAffine3d(Eigen::Vector3d::Zero(),
                    Eigen::Vector3d(-TOOL_PARAMETERS.A_0_Q4 * DEG_TO_RAD, -TOOL_PARAMETERS.B_0_Q4 * DEG_TO_RAD,
                                    -TOOL_PARAMETERS.C_0_Q4 * DEG_TO_RAD - jointAnglesTar(0)),
                    true);
