...
LineTrajectory::LineTrajectory(Eigen::Affine3d startPosition, Eigen::Vector3d RCM, Eigen::Vector3d firstPoint, Eigen::Vector3d secondPoint, int speed, double cycleTime)
{
    speed_ = speed;
    ...
    coefficients[3] = 10*(endPositionTrajectory_.translation()-startPositionTrajectory_.translation())/pow(trajectoryExecutionTime_,3);
    coefficients[4] = -15*(endPositionTrajectory_.translation()-startPositionTrajectory_.translation())/pow(trajectoryExecutionTime_,4);
    coefficients[5] = 6*(endPositionTrajectory_.translation()-startPositionTrajectory_.translation())/pow(trajectoryExecutionTime_,5);
