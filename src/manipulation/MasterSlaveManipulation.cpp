...
bool MasterSlaveManipulation::masterSlaveCallback(masterslave::Manipulation::Request &req,
                                                  masterslave::Manipulation::Response &resp)
{
  ...
  TCPnew.rotate(
      QuaternionFromEuler(Eigen::Vector3d(velocity.twist.angular.x * cycleTime, velocity.twist.angular.y * cycleTime,
                                          velocity.twist.angular.z * cycleTime),
                          true));
